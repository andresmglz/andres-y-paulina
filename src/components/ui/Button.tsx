  ...
  return (
    <Link
      className={clsx(
        ...
        variant === 'primary'
          ? 'bg-[var(--terracotta-dark)] px-6 py-3 text-white shadow-[0_10px_30px_rgba(190,75,3,0.28)] hover:-translate-y-0.5 hover:bg-[var(--terracotta)]'
          : '',
        variant === 'secondary'
          ...
          : '',
        variant === 'heroPrimary'
          ? 'bg-[var(--terracotta-dark)] px-10 py-4 text-[11px] uppercase tracking-[0.22em] text-[var(--surface-paper)] shadow-[0_16px_36px_rgba(190,75,3,0.28),0_0_20px_rgba(219,100,0,0.18)] hover:-translate-y-0.5 hover:bg-[var(--terracotta)]'
          : '',
        ...
        variant === 'heroEditorial'
          ? 'border border-[rgba(190,75,3,0.32)] bg-[rgba(248,238,224,0.8)] px-6 py-2.5 text-[var(--terracotta)] hover:bg-[var(--terracotta-dark)] hover:text-white'
          : '',
        variant === 'heroLight'
        ...
        variant === 'heroStrokeLight'
          ...
          : '',
        variant === 'floating'
          ? 'bg-[var(--terracotta-dark)] px-[22px] py-4 text-white shadow-[0_18px_45px_rgba(190,75,3,0.34)] hover:scale-[1.04] hover:bg-[var(--terracotta)]'
          : '',
      )}
      href={href}
