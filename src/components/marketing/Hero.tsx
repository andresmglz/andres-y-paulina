...
export function Hero({
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(166,187,200,0.14),transparent_30%),radial-gradient(circle_at_85%_18%,rgba(114,142,165,0.16),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(219,100,0,0.08),transparent_18%)]" />
      ...
      <div className="relative z-10 flex min-h-screen items-end px-6 pb-12 pt-24 md:px-10 md:pb-20 lg:pb-28">
        <div className="mx-auto w-full max-w-6xl">
          <div className="relative mx-auto max-w-[39rem] overflow-hidden rounded-[2.6rem] border border-[rgba(246,223,192,0.18)] bg-[linear-gradient(180deg,rgba(50,38,35,0.72),rgba(31,23,20,0.72))] px-6 py-9 text-center text-white shadow-[0_36px_90px_rgba(0,0,0,0.34),0_0_44px_rgba(114,142,165,0.12)] backdrop-blur-[18px] md:px-10 md:py-14">
            ...
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(166,187,200,0.12),transparent_32%),radial-gradient(circle_at_86%_18%,rgba(114,142,165,0.12),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(219,100,0,0.06),transparent_20%)]" />
            ...
            <div className="pointer-events-none absolute left-0 top-0 h-28 w-28 bg-[radial-gradient(circle,rgba(166,187,200,0.14),transparent_68%)]" />
            <div className="pointer-events-none absolute bottom-0 right-0 h-28 w-28 bg-[radial-gradient(circle,rgba(114,142,165,0.12),transparent_68%)]" />
            ...
            <div className="relative z-10">
              ...
              <div className="editorial-divider mx-auto mt-5">
                <span className="h-1.5 w-1.5 rounded-full bg-[var(--terracotta-soft)]" />
              </div>
              ...
              <h2 className="mt-6 font-[family-name:var(--font-heading)] text-[1.7rem] leading-none text-[var(--dusty-blue-soft)] drop-shadow-[0_2px_6px_rgba(0,0,0,0.18)] md:text-[2.1rem]">
                {title}
              </h2>
